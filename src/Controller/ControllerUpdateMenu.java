...
public class ControllerUpdateMenu extends HttpServlet{
...
{	 
	...
	String updatenv=request.getParameter("updatenv") ;
     ...
     BeanUpdateMenu bean = new BeanUpdateMenu();
     bean.setDay(day);
     ...
     DaoUpdateMenu dum=new DaoUpdateMenu();
    	bean =dum.update(bean,request);
    	  if(bean.getValid())
    	  {

...
<style>
form {text-align:center; width:50%; padding:10px; position:absolute; top:25%; left:20%; font-size:1.5em;}
...
<form action="Servlet/ControllerAllStudentPrint" method="POST" enctype="application/x-www-form-urlencoded">

Print all:<input type="submit" value="Click here" />
